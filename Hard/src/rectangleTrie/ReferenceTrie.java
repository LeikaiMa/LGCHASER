...
public class ReferenceTrie {
	// The root of this trie.
    private ReferenceTrieNode root;

    /* Takes a list of strings as an argument, and constructs a trie that stores these strings. */
    public ReferenceTrie(ArrayList<String> list)
    {
    ...
    /* Takes a list of strings as an argument, and constructs a trie that stores these strings. */    
    public ReferenceTrie(String[] list)
    {
        root = new ReferenceTrieNode();
        for (String word : list) {
            root.addWord(word);
    ...
    {
        ReferenceTrieNode lastNode = root;
        int i = 0;
