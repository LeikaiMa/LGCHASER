...
public class ReferenceTrieNode {
    // The children of this node in the trie.
    private LinkedList<ReferenceTrieNode> children;
     ...
     */
    public ReferenceTrieNode() {
            children = new LinkedList<ReferenceTrieNode>();
    }
     ...
     */
    public ReferenceTrieNode(char character) {
        this();
    ...
    public void addWord(String word) {
        ...
        ReferenceTrieNode child;
        char firstChar = word.charAt(0);

        ReferenceTrieNode t = getChild(firstChar);

        if (t == null) {
            child = new ReferenceTrieNode(firstChar);
            children.add(child);
        } else {
            child = t;
        }
     ...
     */
    ReferenceTrieNode getChild(char c) {
        for (ReferenceTrieNode t : children) {
            if (t.getChar() == c) {
                return t;
            }
        }
